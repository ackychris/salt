jre8:
  '8.0.1910.12':
    ...
    full_name: 'Java 8 Update 191 (64-bit)'
    installer: 'salt://win/repo-ng/jre8/jre-8u191-windows-x64.exe'
    uninstall_flags: '/qn /x {26A24AE4-039D-4CA4-87B4-2F64180191F0} /norestart'
    {% else %}
    full_name: 'Java 8 Update 191'
    installer: 'salt://win/repo-ng/jre8_x86/jre-8u191-windows-i586.exe'
    uninstall_flags: '/qn /x {26A24AE4-039D-4CA4-87B4-2F32180191F0} /norestart'
    {% endif %}
